...
You can add ***Agents***, or ***LlmAgents***, to graph-based workflows, however they must be set to a task or single-turn mode. For more information about agent modes, see [Build collaborative agent teams](/adk-docs/workflows/collaboration/#mode-configuration-and-behaviors).
