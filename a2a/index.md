...
- **[A2A Quickstart (Exposing) for Python](https://google.github.io/adk-docs/a2a/quickstart-exposing/index.md)**
- **[A2A Quickstart (Exposing) for Go](https://google.github.io/adk-docs/a2a/quickstart-exposing-go/index.md)**

These guides show you how to allow your agent to use another, remote agent using A2A protocol:

- **[A2A Quickstart (Consuming) for Python](https://google.github.io/adk-docs/a2a/quickstart-consuming/index.md)**
  - **[A2A Extension - V2 Implementation](https://google.github.io/adk-docs/a2a/a2a-extension/index.md)**
- **[A2A Quickstart (Consuming) for Go](https://google.github.io/adk-docs/a2a/quickstart-consuming-go/index.md)**
